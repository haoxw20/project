...
(function(){
    init();
    var $buy = $('section .center p a:eq(0)');
    $buy.click(function(){
        var goodId = $(this).parent().prev().attr('id');
        var goodName = $(this).parent().prev().children().first().text();
        var goodPrice = parseInt($(this).parent().prev().children().children().last().text());
